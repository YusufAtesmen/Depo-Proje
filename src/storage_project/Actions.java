...
static String birimler[]={ S+"", "CUVAL", "PALET", "LİTRE", "ADET","KG",""+R };
    public void depoyaUrunEkleme() {
        ...
        Scanner scan = new Scanner(System.in);//oncesinde satici yetkinlik ve passsword kontrol yap

        //JOptionPane.showMessageDialog(null, "Depoya Urun Indireceksiniz");
        ...
        if (flag) {
            ...
            try {
                ...
                System.out.println(B + " ID     Urun Ismi    Marka           Birim       Miktar      Raf ");
                System.out.println("=================================================================");
...
//private static boolean kontrol(String marka) {
//    System.out.println("elimizde bu markadan var devam etmek icin 1 farklı urun icin 0");
//    boolean flag=true;
//    for (int i = 0; i <keyler.size() ; i++) {
//        if(products.get(keyler.get(i)).getMarka().contains(marka)){
//            flag=false;
//        }
//   }
//    return flag;
//}
    ...
    public static void urunuRafaKoy() throws InterruptedException {
        ...
        switch (rafTercihi) {
            ...
            case 1:
                products.get(keyler.get(keyler.size() - 1)).setRaf("RAF1");

                break;
            case 2:
                products.get(keyler.get(keyler.size() - 1)).setRaf("RAF2");
                break;
            case 3:
                products.get(keyler.get(keyler.size() - 1)).setRaf("RAF3");
                break;
            case 4:
                products.get(keyler.get(keyler.size() - 1)).setRaf("RAF4");
                break;
            default:
